...
//   colorTex    - Texture2D containing RGBA color data (morton-swizzled)
    ...
    uint formatFlags)
{
    ...
    // Color texture coordinate via morton swizzle
