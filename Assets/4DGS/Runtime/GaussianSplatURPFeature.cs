    ...
    internal class GaussianSplatURPFeature : ScriptableRendererFeature
    {
        ...
        private class GsRenderPass : ScriptableRenderPass
        {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                // Must be per-camera (stereoEnabled): URP keeps multiplier 1 for
                // non-stereo cameras (spectator/RTT) even while XR is active, and
                // restoring 2 on exit would double their subsequent draws.
                bool needsMultiplierReset = isSPI && isDevice && stereoEnabled;
